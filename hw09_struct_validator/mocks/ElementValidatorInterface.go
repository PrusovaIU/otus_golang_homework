...
func (_m *ElementValidatorInterface) Validate(_a0 reflect.Value, _a1 reflect.Kind, _a2 string, _a3 string) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 error
	if rf, ok := ret.Get(0).(func(reflect.Value, reflect.Kind, string, string) error); ok {
...
func (_c *ElementValidatorInterface_Validate_Call) Return(_a0 error) *ElementValidatorInterface_Validate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ElementValidatorInterface_Validate_Call) RunAndReturn(run func(reflect.Value, reflect.Kind, string, string) error) *ElementValidatorInterface_Validate_Call {
	_c.Call.Return(run)
	return _c
}
